...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final Circle circle = new Circle(WIDTH / 2, HEIGHT / 2, 475);
        ...
        //  to add them to controls VBox below.
        ...
        controls.getChildren().addAll(
                ...
                jumpToLabel, timesTableNumBox, numPointsBox, jumpToButton);
        // Create the canvas
        ...
        Visualization visualization = new Visualization(ttn, 475);
        // The main "loop"
